...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/qN24qxGX9e)
...
```sh
npx nx serve preview-team
```

To create a production bundle:

```sh
npx nx build preview-team
```

To see all available targets to run for a project, run:

```sh
npx nx show project preview-team
```
